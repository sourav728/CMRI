...
public class UsbService extends Service {
    ...
    public static final int DATA_RECEIVING_STARTED = 3;
    public static final int DATA_RECEIVING_STOPPED = 4;
        ...
        public void onReceive(Context arg0, Intent arg1) {
            if (Objects.equals(arg1.getAction(), ACTION_USB_PERMISSION)) {
                ...
                if (granted) // User accepted our USB connection. Try to open the device as a serial port
                {
                    ...
                    if (mHandler != null)
                        mHandler.obtainMessage(DEVICE_CONNECTED).sendToTarget();
                ...
                if (mHandler != null)
                    mHandler.obtainMessage(DEVICE_DISCONNECTED).sendToTarget();
                try {
                    serialPort.close();
