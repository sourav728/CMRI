package com.tvd.cmri.singlePhase_LT;
...
public class Single extends AppCompatActivity {
        ...
        btn_pres_read.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (usbService != null) { // if UsbService was correctly binded, Send data
                    ...
                    Toast.makeText(Single.this, "Please Connect with Serial Port!!", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public class MyHandler extends Handler {
        private final WeakReference<Single> mActivity;

        MyHandler(Single activity) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case UsbService.DEVICE_CONNECTED:
                    Toast.makeText(Single.this, "Device Connected..", Toast.LENGTH_SHORT).show();
                    disconnect_connect.setBackgroundResource(R.drawable.reconnect);
                    connect_status.setText(R.string.connected);
                ...
                case UsbService.DATA_RECEIVING_STARTED:
                    Toast.makeText(Single.this, "Data Reading Started.." + "\n" + "Please Wait..", Toast.LENGTH_SHORT).show();
                    break;
                case UsbService.DATA_RECEIVING_STOPPED:
                    Toast.makeText(Single.this, "Data Reading Stopped..", Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    }
    ...
    private void writeToFile(String currentStacktrace) {
        try {
            ...
            String filename = "Optical_single_phase" + ".txt";
