...
public class VerEAJ8_02 {
    private FunctionCall functionCall = new FunctionCall();

    private Element B30, B31, B32, B33, B34, B35, B36, B37, B40, B41, B42, B43, B44, B45, B46, B47, B48, B49, B50, B51, B52, B53, B54, B55, B56, B57, B58, B59, B60, B61, B62, B63, B64, B65, B66, B67, B68,
            ...
            B109, B110, B111, B112, B113, B114, B115, B116, B117, B118, B119, B120, B121, B122, B123, B124, B125, B126, B127, B128, B129, B130, B131, B132, B133, B134, B135, B136, B137, B138, B139;
    ...
    private Attr B30attr1, B30attr2, B30attr3, B31attr1, B31attr2, B31attr3, B32attr1, B32attr2, B32attr3, B33attr1, B33attr2, B33attr3, B34attr1, B34attr2, B34attr3, B35attr1, B35attr2, B35attr3,
            ...
            B136attr1, B136attr2, B136attr3, B136attr4, B137attr1, B137attr2, B137attr3, B137attr4, B138attr1, B138attr2, B138attr3, B138attr4, B139attr1, B139attr2, B139attr3, B139attr4;

    public void version_EAJ8_02(ArrayList<GetSetValues> getSetValuesArrayList, Document document,Element d301,Element d3){
        ...
        B30attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(0).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(0).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(0).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(0).getLine_fourth()) + Double.parseDouble(getSetValuesArrayList.get(0).getLine_fifth()))));
        ...
        B31attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(1).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(1).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(1).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(1).getLine_fourth()) + Double.parseDouble(getSetValuesArrayList.get(1).getLine_fifth()))));
        ...
        B32attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(2).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(2).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(2).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(2).getLine_fourth()) + Double.parseDouble(getSetValuesArrayList.get(2).getLine_fifth()))));
        ...
        B33attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(3).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(3).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(3).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(3).getLine_fourth()) + Double.parseDouble(getSetValuesArrayList.get(3).getLine_fifth()))));
        ...
        B34attr2.setValue(getSetValuesArrayList.get(4).getLine_second());
        ...
        B35attr2.setValue(getSetValuesArrayList.get(5).getLine_second());
        ...
        B36attr2.setValue(getSetValuesArrayList.get(6).getLine_second());
        ...
        B37attr2.setValue(getSetValuesArrayList.get(7).getLine_second());
        ...
        B40attr3.setValue(getSetValuesArrayList.get(0).getLine_first());
        ...
        B41attr3.setValue(getSetValuesArrayList.get(1).getLine_first());
        ...
        B42attr3.setValue(getSetValuesArrayList.get(2).getLine_first());
        ...
        B43attr3.setValue(getSetValuesArrayList.get(3).getLine_first());
        ...
        B48attr3.setValue(getSetValuesArrayList.get(0).getLine_second());
        ...
        B49attr3.setValue(getSetValuesArrayList.get(1).getLine_second());
        ...
        B50attr3.setValue(getSetValuesArrayList.get(2).getLine_second());
        ...
        B51attr3.setValue(getSetValuesArrayList.get(3).getLine_second());
        ...
        B52attr3.setValue(getSetValuesArrayList.get(4).getLine_second());
        ...
        B53attr3.setValue(getSetValuesArrayList.get(5).getLine_second());
        ...
        B54attr3.setValue(getSetValuesArrayList.get(6).getLine_second());
        ...
        B55attr3.setValue(getSetValuesArrayList.get(7).getLine_second());
        ...
        B56attr3.setValue(getSetValuesArrayList.get(0).getLine_third());
        ...
        B57attr3.setValue(getSetValuesArrayList.get(1).getLine_third());
        ...
        B58attr3.setValue(getSetValuesArrayList.get(2).getLine_third());
        ...
        B59attr3.setValue(getSetValuesArrayList.get(3).getLine_third());
        ...
        B64attr3.setValue(getSetValuesArrayList.get(0).getLine_fourth());
        ...
        B65attr3.setValue(getSetValuesArrayList.get(1).getLine_fourth());
        ...
        B66attr3.setValue(getSetValuesArrayList.get(2).getLine_fourth());
        ...
        B67attr3.setValue(getSetValuesArrayList.get(3).getLine_fourth());
        ...
        B100attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(8).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(8).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(8).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(8).getLine_fourth()))));
        ...
        B101attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(9).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(9).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(9).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(9).getLine_fourth()))));
        ...
        B102attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(10).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(10).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(10).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(10).getLine_fourth()))));
        ...
        B103attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValuesArrayList.get(11).getLine_first()) + Double.parseDouble(getSetValuesArrayList.get(11).getLine_second()) + Double.parseDouble(getSetValuesArrayList.get(11).getLine_third()) + Double.parseDouble(getSetValuesArrayList.get(11).getLine_fourth()))));
        ...
        B104attr2.setValue(getSetValuesArrayList.get(12).getLine_second());
        ...
        B105attr2.setValue(getSetValuesArrayList.get(13).getLine_second());
        ...
        B106attr2.setValue(getSetValuesArrayList.get(14).getLine_second());
        ...
        B107attr2.setValue(getSetValuesArrayList.get(15).getLine_second());
        ...
        B108attr3.setValue(getSetValuesArrayList.get(8).getLine_first());
        ...
        B109attr3.setValue(getSetValuesArrayList.get(9).getLine_first());
        ...
        B110attr3.setValue(getSetValuesArrayList.get(10).getLine_first());
        ...
        B111attr3.setValue(getSetValuesArrayList.get(11).getLine_first());
        ...
        B116attr3.setValue(getSetValuesArrayList.get(8).getLine_second());
        ...
        B117attr3.setValue(getSetValuesArrayList.get(9).getLine_second());
        ...
        B118attr3.setValue(getSetValuesArrayList.get(10).getLine_second());
        ...
        B119attr3.setValue(getSetValuesArrayList.get(11).getLine_second());
        ...
        B120attr3.setValue(getSetValuesArrayList.get(12).getLine_second());
        ...
        B121attr3.setValue(getSetValuesArrayList.get(13).getLine_second());
        ...
        B122attr3.setValue(getSetValuesArrayList.get(14).getLine_second());
        ...
        B123attr3.setValue(getSetValuesArrayList.get(15).getLine_second());
        ...
        B124attr3.setValue(getSetValuesArrayList.get(8).getLine_third());
        ...
        B125attr3.setValue(getSetValuesArrayList.get(9).getLine_third());
        ...
        B126attr3.setValue(getSetValuesArrayList.get(10).getLine_third());
        ...
        B127attr3.setValue(getSetValuesArrayList.get(11).getLine_third());
        ...
        B132attr3.setValue(getSetValuesArrayList.get(8).getLine_fourth());
        ...
        B133attr3.setValue(getSetValuesArrayList.get(9).getLine_fourth());
        ...
        B134attr3.setValue(getSetValuesArrayList.get(10).getLine_fourth());
        ...
        B135attr3.setValue(getSetValuesArrayList.get(12).getLine_fourth());
