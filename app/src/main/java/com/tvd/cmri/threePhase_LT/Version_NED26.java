...
public class Version_NED26 {
    ...
    public void version_ned26(ArrayList<GetSetValues> getSetValueslist, Document document,Element d301,Element d3){
        ...
        B30attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValueslist.get(0).getLine_first()) + Double.parseDouble(getSetValueslist.get(0).getLine_second()) + Double.parseDouble(getSetValueslist.get(0).getLine_third()) + Double.parseDouble(getSetValueslist.get(0).getLine_fourth()) + Double.parseDouble(getSetValueslist.get(0).getLine_fifth()))));
        ...
        B32attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValueslist.get(2).getLine_first()) + Double.parseDouble(getSetValueslist.get(2).getLine_second()) + Double.parseDouble(getSetValueslist.get(2).getLine_third()) + Double.parseDouble(getSetValueslist.get(2).getLine_fourth()) + Double.parseDouble(getSetValueslist.get(2).getLine_fifth()))));
        ...
        B33attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValueslist.get(3).getLine_first()) + Double.parseDouble(getSetValueslist.get(3).getLine_second()) + Double.parseDouble(getSetValueslist.get(3).getLine_third()) + Double.parseDouble(getSetValueslist.get(3).getLine_fourth()) + Double.parseDouble(getSetValueslist.get(3).getLine_fifth()))));
        ...
        B102attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValueslist.get(10).getLine_first()) + Double.parseDouble(getSetValueslist.get(10).getLine_second()) + Double.parseDouble(getSetValueslist.get(10).getLine_third()) + Double.parseDouble(getSetValueslist.get(10).getLine_fourth()) + Double.parseDouble(getSetValueslist.get(10).getLine_fifth()))));
        ...
        B103attr2.setValue(String.valueOf(functionCall.decimalroundoff(Double.parseDouble(getSetValueslist.get(11).getLine_first()) + Double.parseDouble(getSetValueslist.get(11).getLine_second()) + Double.parseDouble(getSetValueslist.get(11).getLine_third()) + Double.parseDouble(getSetValueslist.get(11).getLine_fourth()) + Double.parseDouble(getSetValueslist.get(11).getLine_fifth()))));
        ...
        B136attr3.setValue(getSetValueslist.get(12).getLine_fourth());
        ...
        B153attr3.setValue(getSetValueslist.get(8).getLine_fifth());
        ...
        B154attr3.setValue(getSetValueslist.get(9).getLine_fifth());
        ...
        B155attr3.setValue(getSetValueslist.get(10).getLine_fifth());
        ...
        B156attr3.setValue(getSetValueslist.get(11).getLine_fifth());
